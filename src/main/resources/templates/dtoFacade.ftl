...
<#list entity.dependencies as dependency>
import com.${projectName?lower_case}.${dependency?lower_case}.${dependency?lower_case}.dto.*;
</#list>
<#if enums??>
<#list enums as enum>
...
public class ${entity.entityName}DTO implements Serializable{
    ...
    private List<${field.dataType}> ${field.fieldName?uncap_first};

    public void set${field.fieldName}(List<${field.dataType}> ${field.fieldName?uncap_first}){
        this.${field.fieldName?uncap_first} = ${field.fieldName?uncap_first};
    }

    public List<${field.dataType}> get${field.fieldName}(){
