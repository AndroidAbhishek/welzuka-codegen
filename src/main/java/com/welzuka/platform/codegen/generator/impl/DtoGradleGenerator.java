...
public class DtoGradleGenerator {

    private static DtoGradleGenerator engine = new DtoGradleGenerator();
    private Template template=null;
    Map<String, Object> dataMap = new HashMap<String, Object>();
    private DtoGradleGenerator()
    {
        init();
    }
    private void init()
    {
        ...
        try {
            ...
            template = cfg.getTemplate("dtoGradle.ftl");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static DtoGradleGenerator get()
    {
        return engine;
    }

    public DtoGradleGenerator buildData(String componentName, Component component)
    {
