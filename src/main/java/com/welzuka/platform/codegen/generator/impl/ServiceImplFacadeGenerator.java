...
public class ServiceImplFacadeGenerator {

    private static ServiceImplFacadeGenerator engine = new ServiceImplFacadeGenerator();
    private Template template=null;
    Map<String, Object> dataMap = new HashMap<String, Object>();
    private ServiceImplFacadeGenerator()
    {
        init();
    }
    ...
    private void init()
    {
        ...
        try {
            ...
            template = cfg.getTemplate("serviceImplFacade.ftl");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static ServiceImplFacadeGenerator get()
    {
        return engine;
    }

    public ServiceImplFacadeGenerator buildData(String componentName, Component component, Entity entity)
    {
