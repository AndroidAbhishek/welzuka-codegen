...
public class DTOGenerator {
    ...
    private static DTOGenerator engine = new DTOGenerator();
    ...
    public static DTOGenerator get()
    {
        return engine;
    }

    public DTOGenerator buildData(String componentName, Component component, Entity entity, List<String> enums)
    {
