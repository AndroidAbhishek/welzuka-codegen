...
public class ClientFacadeGenerator {

    private static ClientFacadeGenerator engine = new ClientFacadeGenerator();
    private Template template=null;
    Map<String, Object> dataMap = new HashMap<String, Object>();
    private ClientFacadeGenerator()
    {
        init();
    }
    private void init()
    {
        ...
        try {
            ...
            template = cfg.getTemplate("clientFacade.ftl");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static ClientFacadeGenerator get()
    {
        return engine;
    }

    public ClientFacadeGenerator buildData(String componentName, Component component, Entity entity)
    {
